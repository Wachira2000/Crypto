        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 py-16">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              ...
              <span className="text-2xl font-bold text-white">CryptoLend</span>
            </div>
            ...
            <div className="flex items-center gap-4">
              {[
                ...
                { name: 'X', icon: 'M18.901 1.566h-3.73L13.89.049 7.41 6.42l-5.15-4.9H0l6.84 6.505L0 16.434h3.73l1.28-1.516 6.48-6.375 5.15 4.9h3.341L12.06 9.95l6.84-6.505zm-3.28 12.963h-1.15L4.571 3.362h1.15l11.05 11.167z' },
          ...
          {[
            {
              title: "Products",
              links: ["Crypto Loans", "Interest Rates", "Loan Calculator", "Asset Coverage"]
            },
            {
              title: "Company",
